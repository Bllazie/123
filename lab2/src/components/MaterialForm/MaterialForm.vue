<template>
  <div :class="$style.root">
    ...
    <div :class="$style.item">
      ...
      <input :value="form.material_name" disabled :class="$style.input" id="material_name" placeholder="material_name" type="text">
    </div>
...
import { selectItemById, fetchMaterials, selectItems } from '@/store/materials/selectors';
